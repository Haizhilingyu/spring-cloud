...
// 取进程信息
                ...
                log.error("获取CPU使用情况异常", ex.fillInStackTrace());
                return 0.0;
            }
            ...
            try {
                ...
                log.error("获取CPU使用情况异常", e.fillInStackTrace());
            }
        }
        return 0.0;
    }
    ...
    private static Map<?, ?> cpuinfo() {
        ...
        try {
            ...
            try {
                ...
                log.error("释放资源异常", e2.fillInStackTrace());
            }
        }
        return map;
    }
...
// 剩余的物理内存
                ...
                log.error("获取内存使用情况异常", e.fillInStackTrace());
            }
        } else {
            Map<String, Object> map = new HashMap<String, Object>();
            InputStreamReader inputs = null;
    ...
    public static double getDiskUsage() {
        ...
        if (osName.toLowerCase().contains("windows")
            ...
            try {
                ...
                log.error("获取磁盘使用情况异常", e.fillInStackTrace());
            }
